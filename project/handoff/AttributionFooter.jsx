 ...
 *
 * Every third-party provider we draw artwork or metadata from carries a
 * legal obligation. This component is the single place that obligation is
 * expressed, so a media screen physically cannot render provider artwork
 * without the credit travelling with it.
 *
 * Usage:
 ...
 *
 * Dependencies: react-native-svg. No other packages required.
 */
...
export const ATTRIBUTION = {
  ...
  apple: {
    ...
    name: 'Apple',
    required:
      'Apple, the Apple logo and Apple Podcasts are trademarks of Apple Inc.',
  ...
  google: {
    ...
    name: 'Google Books',
    required:
      'Book data powered by Google. Google is a trademark of Google LLC.',
  ...
  openlibrary: {
    ...
    name: 'Open Library',
    required:
      'Data from Open Library, a project of the Internet Archive, used under an open data licence.',
...
export const ATTRIBUTION_BY_MEDIUM = {
  FILM: ['tmdb', 'wikipedia'],
  TV: ['tmdb', 'tvmaze'],
...
export function providersFor(medium) {
  return (ATTRIBUTION_BY_MEDIUM[medium] || [])
    .map((id) => ATTRIBUTION[id])
    .filter(Boolean);
}
    ...
    case 'google':
      return (
        <Svg width={size} height={size} viewBox="0 0 48 48">
          <Path
            fill="#EA4335"
            d="M24 9.5c3.5 0 6.6 1.2 9 3.6l6.8-6.8C35.6 2.5 30.2 0 24 0 14.6 0 6.5 5.4 2.6 13.2l7.9 6.2C12.4 13.7 17.7 9.5 24 9.5z"
          />
          <Path
            fill="#4285F4"
            d="M46.1 24.6c0-1.6-.1-2.8-.4-4.1H24v9.1h12.6c-.3 2.1-1.6 5.2-4.6 7.3l7.7 6c4.6-4.3 6.4-10.4 6.4-18.3z"
          />
          <Path
            fill="#FBBC05"
            d="M10.5 28.6A14.6 14.6 0 019.7 24c0-1.6.3-3.2.8-4.6l-7.9-6.2A24 24 0 000 24c0 3.9.9 7.5 2.6 10.8l7.9-6.2z"
          />
          <Path
            fill="#34A853"
            d="M24 48c6.5 0 11.9-2.1 15.7-5.8l-7.7-6c-2.1 1.4-4.8 2.3-8 2.3-6.3 0-11.6-4.2-13.5-9.9l-7.9 6.2C6.5 42.6 14.6 48 24 48z"
          />
        </Svg>
      );
    case 'openlibrary':
...
export default function AttributionFooter({
  ...
  if (variant === 'compact') {
    return (
      <View style={[s.compactWrap, style]}>
...
/* Palette tokens. Keep in step with the design system rather than editing
